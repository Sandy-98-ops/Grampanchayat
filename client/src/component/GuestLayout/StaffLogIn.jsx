  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const student = result.staff;

        cookies.set('staffData',
          JSON.stringify(student), { path: '/' })

        console.log(cookies.get('staffData'))

        navigate('/staff'); // Redirect to admin layout
      ...
      <Container className='container-2'>
        ...
        <div className="form form-1">
          ...
          <Form onSubmit={handleLoginSubmit}>
            ...
            <Link to="/staffForgotPassword" className="forgot-password d-block mb-3">
              Forgotten password?
            </Link>
            <hr />
          </Form>
