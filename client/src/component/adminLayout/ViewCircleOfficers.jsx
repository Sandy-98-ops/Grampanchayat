...
import { getAllCircleOfficers } from '../../utils/api';
import { Button, Col, Container, Row } from 'react-bootstrap';

const ViewCircleOfficers = () => {
    ...
    const getCircleOfficers = async () => {
        try {
            const response = await getAllCircleOfficers();
            if (response.ok) {
        ...
        <div>
            <Container className="container-1">
                <div className="list-container scrollable-list">
                    <Row>
                        <Col xs={12} sm={8}>
                            <h2 className="mb-4">Circle Officers</h2>
                        </Col>
                    </Row>
                    ...
                    <Row className="table-header pb-2 pt-2 GuestHeader">
                        ...
                        <Col xs={12} sm={2} className="text-center">Circle</Col>
                    ...
                    {circleOfficers.map((circleOfficer, index) => (
                        <Row key={index} className="table-row">
                            ...
                            <Col xs={12} sm={2} className="text-center">{circleOfficer.circle}</Col>
...
export default ViewCircleOfficers
