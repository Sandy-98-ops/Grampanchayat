...
const CircleOfficerHeader = () => {
    const navigate = useNavigate();

    const handleSelect = (eventKey) => {
        switch (eventKey) {
            case 'edit-profile':
                navigate('/circleOfficer/edit-profile');
                break;
            case 'change-password':
                navigate('/circleOfficer/change-password');
                break;
            case 'logout':
                // Clear cookies
                Cookies.remove('circleOfficerData');
...
export default CircleOfficerHeader
